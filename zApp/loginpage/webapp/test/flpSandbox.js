		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#inkitloginloginpage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"inkitloginloginpage-display": {
								"semanticObject": "inkitloginloginpage",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=inkit.login.loginpage",
									"url": sap.ui.require.toUrl("inkit/login/loginpage")
								}
							}
						}
					}
